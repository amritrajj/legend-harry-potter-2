...
from Harry.menu import *
from Harry import *
from Harry.modules import ALL_MODULES
from Harry.utils import paginate_modules
from lang import get_command
from Harry.utils.lang import *
from Harry.utils.commands import *
from Harry.mongo.rulesdb import *
from Harry.utils.start import *
from Harry.mongo.usersdb import *
from Harry.mongo.restart import *
from Harry.mongo.chatsdb import *
from Harry.modules.fsub import ForceSub
import random
...
async def start_bot():
    ...
    for module in ALL_MODULES:
        imported_module = importlib.import_module("Harry.modules." + module)
        if (
...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        ...
        [
            ...
            InlineKeyboardButton(
                text="🔰News Channel",
                url=f"https://t.me/tech_sav_bots",
            )
        ],
    ]
)
...
[👋]({random.choice(IMG)}) Hey there {message.from_user.mention}, 
   ...
   My name is Harry Potter, an  advanced telegram Group management Bot For helpYou Protect Your Groups & Suit For All Your Needs. 
I currently manage about `{len(served_chats)}` groups.I have over `{len(served_users)}` users

⚒ Send Me /help For Get Commands. 
👨‍💻Dᴇᴠᴇʟᴏᴘᴇʀ : @amritraj20_08
""",
...
👋 Hey there {CallbackQuery.from_user.mention}, 
   ...
   My name is Harry Potter ,an  advanced telegram Group management Bot For help 
