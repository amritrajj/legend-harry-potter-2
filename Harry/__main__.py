...
PM_START_TEXT = """
Hey there! My name is Harry Potter.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD TO YOUR GROUP ➕️", url="https://t.me/legend_harry_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="Updates", url="https://t.me/tech_sav_bots"),
        InlineKeyboardButton(text="Support", url="https://t.me/tech_sav_bot"),
    ],
    [
        InlineKeyboardButton(
...
You Can donate to this bot via [Paytm](https;//t.me/amritraj20_08)"""
...
@run_async
def harry_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "harry":
        query.message.edit_text(
            text=""" 🤖 I'm *Harry Potter*, a powerful group management bot built to help you manage your group easily.
...
❍ I check for admins' permissions before executing any command and more stuffs
                 ...
                 Here is the [💾Dovumentary](https://github.com/amritraj2008).
                 If you have any question about Group Menter, let us know at @tech_sav_bots.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Harry Potter*
                 \nHere is the [Support chat](https://t.me/Tech_sav_bot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
